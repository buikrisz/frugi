    ...
    <div className="pdfBg" onClick={handleClick}>
      <div className="pdfContainer">
        ...
        <div>
          ...
          <a href={biopren_csotany} download="BIOPREN-csotanyirto-gel_hu">
            BIOPREN csótányirtó gél
          </a>
        </div>
        <div>
          <MdFileDownload className="pdfIcon" />
          <a href={biopren_hangyairto} download="BIOPREN-hangyairto-gel_hu">
        ...
        <div>
          ...
          <a
            href={gohkilaht}
            download="Gokilaht_10MC_rovarirto_koncentratum_hu_v1"
          >
        ...
        <div>
          ...
          <a
            href={peststop_10ec}
            download="PESTSTOP_10EC_rovarirto_koncentratum"
          >
        ...
        <div>
          ...
          <a
            href={peststop_combi}
            download="PestStop_Combi_8_CS_rovarirto_koncentratum_hu_v7"
          >
        ...
        <div>
          ...
          <a
            href={protect_pro}
            download="PROTECT-PRO-paraffinos-ragcsaloirto-blokk_hu"
          >
        ...
        <div>
          ...
          <a
            href={antivespe}
            download="ANTIVESPE_darazsirto_aeroszol_biztonsagi_adatlap_doc"
          >
        ...
        <div>
          <MdFileDownload className="pdfIcon" />
          <a href={bombex_farumy} download="Bombex_Farumy">
            Bombex Farumy
          </a>
        </div>
        <div>
          ...
          <a
            ...
            download="Protect_darazsirto_aeroszol_hu_v5"
          >
        ...
        <div>
          ...
          <a
            ...
            download="PROTECTr_Forte_rovarirto_porozoszer_hu_v3"
          >
        ...
        <div>
          ...
          <a
            ...
            download="BIOPREN_6_EC_agyi_poloska-es_bolhairto_koncentratum_hu_v7"
          >
        ...
        <div>
          <MdFileDownload className="pdfIcon" />
          <a href={deltasect} download="Deltasect_HU4">
            Deltasect
          </a>
        </div>
        <div>
          ...
          <a
            ...
            download="PESGUARD-B_koncentratum_MSDS_3v_160601"
          >
        ...
        <div>
          ...
          <a
            ...
            download="msds-Aquapy-Rovarirto-koncentratum-CLP-11789"
          >
        ...
        <div>
          ...
          <a
            ...
            download="Dk-10.2-Rovarirto-Koncentratum_hu_v4"
          >
        ...
        <div className="lastDiv">
          <MdFileDownload className="pdfIcon" />
          <a href={cleankill} download="cleankill">
            Cleankill
          </a>
        </div>
      </div>
