...
function PestControl() {
  ...
  const pestServiceStructuredData = {
    ...
    description:
      "Minőségi kártevőirtás (ágyi poloska, csótány, patkány, darázs, hangya, moly)",
    address: "2120, Dunakeszi Mária utca 23.",
    email: "frugiozone@gmail.com",
    founder: "Kovács Tibor Géza",
    keywords:
      "ágyi poloska, csótány, patkány, darázs, hangya, moly, irtás, rovar, rovarirtás, kártevő, rágcsáló",
  ...
  return (
    <Layout>
      ...
      <MetaTags>
        ...
        <meta
          name="keywords"
          content="ágyi poloska, ágyi poloska csípése, ágyi poloska irtás, csotány irtás házilag, csótány irtás, rovarirtás"
        ></meta>
      </MetaTags>
      <PestLandingSection />
      <PestAboutSection />
